package ke.co.suluhutex.app.repository;

import ke.co.suluhutex.app.SuluhutexsystemApp;
import ke.co.suluhutex.app.config.Constants;
import ke.co.suluhutex.app.config.audit.AuditEventConverter;
import ke.co.suluhutex.app.domain.PersistentAuditEvent;
...
import static ke.co.suluhutex.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
